...
// handle
//
EVT_WDF_DEVICE_PREPARE_HARDWARE JDriverEvtDevicePrepareHardware;


EVT_WDF_DEVICE_D0_ENTRY JDriverEvtDeviceD0Entry;

EVT_WDF_DEVICE_D0_EXIT  JDriverEvtDeviceD0Exit;
